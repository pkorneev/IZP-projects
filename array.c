...
void *array_append(Array *a, Person *p)
{
    if (array_inc(a))
...
void array_remove(Array *a, unsigned int idx)
{
...
unsigned int array_find_min(Array *a, int idx)
{
    // TODO
}

// Seradi osoby v poli podle jejich id (a pripadne jmena)
